        ...
        <div className="carousel-item active">
          ...
          <div className="carousel-caption d-md-block">
            <div className="container">
              ...
              <p>
                At Global Pay, we offer seamless solutions across recruitment,
                real estate, and educational consulting. Let us help you
                navigate your journey to success with tailored services for your
                needs.
              </p>
              <Link
